...
Usage:
    ...
    python config_helper.py get    <reponame> <key>        # print value of one key, or empty string
    python config_helper.py set    <reponame> <key> <value># set one key and save

Examples:
    python config_helper.py read   my-repo
    python config_helper.py get    my-repo default_branch
    python config_helper.py set    my-repo default_branch dev
    python config_helper.py set    my-repo deploy_workflow deploy.yml
"""
